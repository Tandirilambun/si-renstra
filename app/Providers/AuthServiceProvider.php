...
class AuthServiceProvider extends ServiceProvider
{
    ...
    {
        // Gate::define('notif-access', function(Users $users){
        //     $direktur = $users -> role === 'DIREKTUR';
        //     $wakil = $users -> role === 'WAKIL DIREKTUR';
        //     $kep_dept = $users -> role === 'KEPALA DEPARTEMEN';
        //     $kep_unit = $users -> role === 'KEPALA UNIT';
        //     return [$direktur, $wakil, $kep_dept, $kep_unit];
        // });
        // Gate::define('updating-access',function(Users $users){
        //     $users
        // });
