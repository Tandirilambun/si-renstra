                ...
                <div class="d-flex justify-content-center align-items-center" style="gap:2%;">
                    <div class="col">
                        <div class="card card-wrapper border border-0 rounded rounded-5"
                            ...
                            <a href="home/create" class="card-body card-self py-5 border border-0 rounded rounded-5"
        ...
        @cannot('staff')
            <nav class="mb-4">
                <div class="nav nav-pills" id="nav-tab" role="tablist">
                    <button class="nav-link notif-tabs active mx-2 position-relative" id="nav-new-tab" data-bs-toggle="tab"
                        ...
                        @foreach ($notif_new as $item)
                            <div class="accordion-item notif-item mb-2 border-0">
                                <h2 class="accordion-header">
                                    <button class="accordion-button accor-btn collapsed px-3 notif-item rounded rounded-2" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#notif-flush-{{ $item->id_request }}"
                                        aria-expanded="false" aria-controls="notif-flush-{{ $item->id_request }}"
