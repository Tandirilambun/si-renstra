<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="/renstrapage/{{$id}}/use-of-output/{{$useOfOutput -> id_use_of_output}}">Use Of Output</a></li>
            ...
            <form action="/capaian-indikator-use-of-output" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="tahun-capaian">Tahun</label>
                        <input required type="number" class="form-control" id="tahun-capaian"
                            placeholder="Tahun Capaian" name="tahun_capaian" style="width: auto" value="{{$useOfOutput -> periode -> tahun_awal}}">
                    </div>
                    <div class="mb-3">
                        <label for="input-hasil">Hasil</label>
