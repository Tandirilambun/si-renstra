<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="/renstrapage/{{$id}}/general-objective/{{$generalObjective -> id_general}}">General Objective</a></li>
            ...
            <form action="/capaian-indikator-general" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="tahun-capaian">Tahun</label>
                        <input required type="number" class="form-control" id="tahun-capaian"
                            placeholder="Tahun Capaian" name="tahun_capaian" style="width: auto" value="{{$generalObjective -> periode -> tahun_awal}}">
                    </div>
                    <div class="mb-3">
                        <label for="input-hasil">Hasil</label>
