<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="/renstrapage/{{$id}}/outcome/{{$outcome -> id_outcome}}">Outcome</a></li>
                        ...
                        <div class="d-flex">
                            <form action="/capaian-indikator-outcome/{{ $capaian->id_capaian_outcome }}"
                                ...
                                <button class="btn btn-capaian p-0 me-1 d-flex justify-content-center align-items-center"
                                    style="background-color:red; border-radius:100%;" onclick="return confirm('Are you sure to delete this data?')">
            ...
            <form action="/capaian-indikator-outcome" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="tahun-capaian">Tahun</label>
                        <input required type="number" class="form-control" id="tahun-capaian"
                            placeholder="Tahun Capaian" name="tahun_capaian" style="width: auto" value="{{$outcome -> periode -> tahun_awal}}">
                    </div>
                    <div class="mb-3">
                        <label for="input-hasil">Hasil</label>
